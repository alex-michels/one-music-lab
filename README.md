...
- Russian Sound lab intentionally combines Russian names in “A little experiment” with international labels in its other existing panels. These displays are accepted. Traditional Russian notation has priority in new Russian laboratory material; international notation remains valid and is not a localization error. See the [notation scope](docs/music-notation.md#scope-of-future-localization-work).
